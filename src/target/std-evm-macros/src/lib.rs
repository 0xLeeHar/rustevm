...
///    `#[unsafe(no_mangle)] pub extern "C" fn __evm_fn_XXXXXXXX()` shim, where
...
/// Generate `#[unsafe(no_mangle)] pub extern "C" fn __evm_fn_XXXXXXXX() { … }`.
...
/// 2. Emits a `#[unsafe(no_mangle)] pub extern "C" fn __evm_constructor()` shim that
